        ...
        <div x-data="{ notificationOpen: false }" class="relative">
            ...
            <div x-show="notificationOpen"
                ...
                <a href="#"
                   class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                    <img class="h-8 w-8 rounded-full object-cover mx-1"
                         src="{{ asset('image/a.jpg') }}"
                         alt="avatar">
                    <p class="text-sm mx-2">
                        <span class="font-bold" href="#">Muhammad Omar Haj Hamdo</span> replied on the <span
                ...
                <a href="#"
                   class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                    <img class="h-8 w-8 rounded-full object-cover mx-1"
                         src="{{ asset('image/i.jpg') }}"
                         alt="avatar">
                    <p class="text-sm mx-2">
                        <span class="font-bold" href="#">Muhammad Omar Haj Hamdo</span> start following you . 45m
                    </p>
                </a>
                <a href="#"
                   class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-indigo-600 -mx-2">
                    <img class="h-8 w-8 rounded-full object-cover mx-1"
                         src="{{ asset('image/gym.png') }}"
                         alt="avatar">
                    <p class="text-sm mx-2">
                        <span class="font-bold" href="#">Muhammad Omar Haj Hamdo</span> Like Your reply on <span
