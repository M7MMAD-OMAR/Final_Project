<section class="container mx-auto p-6 font-mono">
    <form action="{{ route('admin.serie.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="relative mb-4">
            ...
            <input type="text" id="name" name="name" min="2" required
        ...
        <div class="relative mb-4">
            <label for="created_year" class="leading-7 text-sm text-gray-600">Created Year</label>
            <input type="date" id="created_year" name="created_year" required
                   class="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        </div>
        ...
        <div class="relative mb-4">
            <label for="poster_path" id="file_input"
                ...
                Image</label>
            <input id="file_input" type="file" name="poster_path" required
