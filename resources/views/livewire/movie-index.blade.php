        ...
        <section class="text-gray-600 body-font relative container mx-auto px-8 py-8 rounded-xl">
            <form action="{{ route('admin.movie.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="relative mb-4">
                    ...
                    <input type="number" id="vote_average" name="vote_average" min="0" max="8" required
                           class="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                ...
                <div class="relative mb-4">
                    ...
                    <input type="text" id="original_language" name="original_language" maxlength="2" required
                           class="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>

                <div class="relative mb-4">
                    <label for="is_public" class="leading-7 text-sm text-gray-600">Public</label>
                    <input type="number" id="is_public" name="is_public" min="0" max="1" required
                           class="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                ...
                <div class="relative mb-4">
                    <label for="poster_path" id="file_input"
                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Upload
                        Image</label>
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3 text-sm border">
                            <x-m-button wire:click="showTrailerModal({{ $table_movie->id }})"
                                        class="bg-indigo-500 hover:bg-indigo-700 text-white">Trailer
                            </x-m-button>
                            <x-m-button wire:click="showEditModal({{ $table_movie->id }})"
                                        class="bg-green-500 hover:bg-green-700 text-white">Edit
                            </x-m-button>
